...
/**
    ...
    funds should be split based on each party's actions in relation to the agreement terms. If the
    parties disagree, they can summon a predefined arbitrator to settle their dispute.
...
contract AgreementManager is SafeUtils, EvidenceProducer {
    ...
    uint constant PENDING_EXTERNAL_CALL = 9;
